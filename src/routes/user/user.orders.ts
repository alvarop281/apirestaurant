...
import { 
    orderActiveValidate,
    orderInHouseValidate } from '../../middleware/orderValidate';
...
import { 
    ...
    getOrders, 
    updateOrder,
    updateCalificationOrder } from '../../controllers/order.controller';
import { 
    getDetails,
    createDetail, 
    deleteADetail, 
...
router.route('/close/orders/:orderId')
    .put([
        body('status').optional().not().exists().withMessage('Invalid request'),
        body('user_id').optional().not().exists().withMessage('Invalid request'),
        body('commentary').optional().not().exists().withMessage('Invalid request'),
    ...
    ], verifyToken, userValidate, validateReq, orderInHouseValidate, updateCalificationOrder)
